...
CREATE TABLE application_language (     
 ...
 CREATE TABLE Users (     id INT AUTO_INCREMENT PRIMARY KEY,     FormId INT,     Login VARCHAR(255) NOT NULL,     Password VARCHAR(255) NOT NULL,     FOREIGN KEY (FormId) REFERENCES Applicationss(id) );
